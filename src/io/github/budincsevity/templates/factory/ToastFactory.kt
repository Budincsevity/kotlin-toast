...
import io.github.budincsevity.templates.ToastText01
import io.github.budincsevity.templates.ToastText02
import io.github.budincsevity.templates.ToastText03
import io.github.budincsevity.templates.ToastText04

class ToastFactory {
    fun getInstance(toastType: ToastType, headlineText: String, bodyText: String = "", bodyText2: String = ""): BaseToast {
        return when (toastType) {
            ToastType.TOAST_TEXT_1 -> ToastText01(bodyText)
